...
namespace EfCoreAzureAD
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                dbContext.UseSqlServer(_configuration.GetConnectionString("ConnectionStrings"));                        
                dbContext.AddInterceptors(provider.GetRequiredService<AadAuthenticationInterceptor>());
            });
